        ...
        <nav className={`fixed w-full top-0 z-50 transition-all duration-500 ${scrolled
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center">
                    ...
                    <Link href="/" onClick={handleLogoClick} className="group relative">
                        {/* Animated Background */}
                        ...
                        {/* Logo Content */}
                        <div className="relative flex items-center gap-2 px-4 py-2 bg-white/90 backdrop-blur-sm rounded-2xl border border-gray-100 shadow-md group-hover:shadow-xl transition-all duration-300 cursor-pointer">
                            {/* Initial Circle */}
                            <div className="w-8 h-8 rounded-full bg-gradient-to-r from-blue-600 to-purple-600 flex items-center justify-center shadow-md group-hover:scale-110 transition-transform duration-300">
                            ...
                            {/* Little Dot */}
                            <span className="w-1.5 h-1.5 rounded-full bg-gradient-to-r from-blue-600 to-purple-600 animate-pulse"></span>
                        </div>
                    </Link>

                    {/* Desktop Navigation - সব লিংক */}
                        ...
                        {navLinks.map((link) => {
                            ...
                            return (
                                <a
                                    ...
                                    className={`group relative px-3 py-2 rounded-full text-sm font-medium transition-all duration-300 flex items-center gap-2 cursor-pointer ${isActive
                    ...
                    <div className="lg:hidden">
                        <button
                            ...
                            className="relative w-10 h-10 rounded-full bg-gradient-to-r from-blue-500 to-purple-500 text-white flex items-center justify-center shadow-lg hover:scale-105 transition-all duration-300"
                        >
            ...
            {/* Mobile Menu - সব লিংক */}
            <div className={`lg:hidden fixed top-16 left-0 right-0 bg-white/95 backdrop-blur-md shadow-lg transition-all duration-300 transform z-50 ${isMenuOpen ? "translate-y-0 opacity-100" : "-translate-y-full opacity-0 pointer-events-none"
                }`}>
